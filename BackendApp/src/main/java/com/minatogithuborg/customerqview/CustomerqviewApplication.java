package com.minatogithuborg.customerqview;
...
@SpringBootApplication(scanBasePackages = {"com.vs.rappit","com.vs","com.minatogithuborg.customerqview"})
@EnableCaching
...
public class CustomerqviewApplication {

	public static void main(String[] args) {
		SpringApplication.run(CustomerqviewApplication.class, args);
	}
