...
public class COrderBaseService<T extends COrderBase> extends BaseJPABusinessLogic<T>
	...
	private static final Logger LOGGER = LoggerFactory.getLogger(COrderBaseService.class.getName());
	...
	@Autowired
	private  COrderPerimeterBaseImpl corderPerimeterBaseImpl;
	
	
	public COrderBaseService(Class<T> modelClass) {
		super(modelClass);
	...
	public void onAfterSaveDB(T modelObj) {
	  changelogService.createChangeLog("COrder", modelObj.getSid(), Constants.SAVED, modelObj);
	}
	...
	public void onAfterUpdateDB(T modelObj) {
	  changelogService.createChangeLog("COrder", modelObj.getSid(), Constants.UPDATED, modelObj);
	}
	...
	public void onAfterDeleteDB(T modelObj) {
	  changelogService.createChangeLog("COrder", modelObj.getSid(), Constants.DELETED, modelObj);
	}	
