...
import { CorderApiConstants } from './corder.api-constants';
...
public baseService = inject(BaseService);
	  ...
	  getProtoTypingData(): Observable<any> {
	      const subject:Observable<CorderBase> = new Observable(observer => {
	        const data =  require('base/assets/sample-data/corder.json');
	        observer.next(data as CorderBase);
	      });
	      return subject;
	  }
	    ...
	    let data: any = {};
	    const subject: Observable<CorderBase> = new Observable(observer => {
	      const response = require('base/assets/sample-data/corder.json');
	      response.map((o: any) => {
    ...
    autoSuggestService(...args: any):Observable<any>{
        const serviceOpts = CorderApiConstants.autoSuggestService;
        const params= args[0];
    ...
    create(...args: any):Observable<any>{
        const serviceOpts = CorderApiConstants.create;
        const params= args[0];
    ...
    getDatatableData(...args: any):Observable<any>{
        const serviceOpts = CorderApiConstants.getDatatableData;
        const params= args[0];
    ...
    getById(...args: any):Observable<any>{
        const serviceOpts = CorderApiConstants.getById;
        const params= args[0];
    ...
    delete(...args: any):Observable<any>{
        const serviceOpts = CorderApiConstants.delete;
        const params= args[0];
    ...
    getBypk_ordernoIndex(...args: any):Observable<any>{
        const serviceOpts = CorderApiConstants.getBypk_ordernoIndex;
        const params= args[0];
