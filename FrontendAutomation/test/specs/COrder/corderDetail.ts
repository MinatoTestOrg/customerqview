...
const testJSON = require('../../pageobjects/standardPageobjects/COrder/corderDetail.json');
const testCustomJSON = require('../../pageobjects/customPageobjects/COrder/corderDetail.json');
const mockData = require('../../mockData/COrder/corderDetailmockdata.json')
