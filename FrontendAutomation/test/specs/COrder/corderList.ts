...
const testJSON = require('../../pageobjects/standardPageobjects/COrder/corderList.json');
const testCustomJSON = require('../../pageobjects/customPageobjects/COrder/corderList.json');
const mockData = require('../../mockData/COrder/corderListmockdata.json')
