...
const testJSON = require('../../pageobjects/standardPageobjects/CProduct/cproductDetail.json');
const testCustomJSON = require('../../pageobjects/customPageobjects/CProduct/cproductDetail.json');
const mockData = require('../../mockData/CProduct/cproductDetailmockdata.json')
