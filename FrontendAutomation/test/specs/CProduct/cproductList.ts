...
const testJSON = require('../../pageobjects/standardPageobjects/CProduct/cproductList.json');
const testCustomJSON = require('../../pageobjects/customPageobjects/CProduct/cproductList.json');
const mockData = require('../../mockData/CProduct/cproductListmockdata.json')
