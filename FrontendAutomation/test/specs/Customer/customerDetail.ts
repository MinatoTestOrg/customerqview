...
const testJSON = require('../../pageobjects/standardPageobjects/Customer/customerDetail.json');
const testCustomJSON = require('../../pageobjects/customPageobjects/Customer/customerDetail.json');
const mockData = require('../../mockData/Customer/customerDetailmockdata.json')
