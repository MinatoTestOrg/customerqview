...
const testJSON = require('../../pageobjects/standardPageobjects/Customer/customerList.json');
const testCustomJSON = require('../../pageobjects/customPageobjects/Customer/customerList.json');
const mockData = require('../../mockData/Customer/customerListmockdata.json')
